...
namespace BlazorBitcoinApp.Services
{
    public class BitcoinService : IBitcoinService
    {
        ...
        {
            var response = await _httpClient.GetAsync("https://data.messari.io/api/v1/markets/binance-btc-usdt/metrics/price/time-series?start=" + startDate.ToString("yyyy-MM-dd") + "&interva=1d");
